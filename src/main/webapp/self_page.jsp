...
<div class="container">
    ...
    <div class="col-lg-7 col-lg-offset-2" id="self-page">
        <table class="table table-strip table-hover">
            <tr>
                <td><span class="col-lg-4 col-lg-offset-2">姓名：</span><span class="col-lg-5">李志琛</span></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><span class="col-lg-4 col-lg-offset-2">邮箱：</span><span class="col-lg-5">1471585088@qq.com</span></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><span class="col-lg-4 col-lg-offset-2">个人简介：</span><span class="col-lg-5">我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛我是李志琛</span></td>
            </tr>
        </table>
    </div>
</div>
