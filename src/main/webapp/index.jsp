...
<head>
    ...
    <style type="text/css">
        body{background: url(/static/images/2.jpg) no-repeat;background-size:cover;font-size: 16px;}
...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id = "home">
        <div class = "form row">
            <form class="form-horizontal col-sm-offset-2 col-md-offset-2" id="login_form" role="form" action="RegisterAction">
